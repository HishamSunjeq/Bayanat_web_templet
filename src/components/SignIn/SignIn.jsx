      ...
      <div className="row vh-100">
        ...
        <div className="col-lg-6 d-none d-lg-flex align-items-center justify-content-center left-column">
          <div className="text-center">
            ...
            <h2 className="text-white mb-3 animate-text">
              Welcome to Payment Hub
            </h2>
            <p className="text-white-50 lead animate-text-delay">
              Your Professional Digital Transformation Platform
            </p>
            <div className="mt-5">
              <div className="d-flex justify-content-center">
                <div className="feature-item mx-3 animate-feature">
                  <i
                    className="bi bi-shield-lock text-white mb-2"
                    style={{ fontSize: "2rem" }}
                  ></i>
                  <p className="text-white-50 small">Enterprise Security</p>
                </div>
                <div
                  className="feature-item mx-3 animate-feature"
                  style={{ animationDelay: "0.2s" }}
                >
                  <i
                    className="bi bi-graph-up text-white mb-2"
                    style={{ fontSize: "2rem" }}
                  ></i>
                ...
                >
                  <i
                    className="bi bi-gear text-white mb-2"
                    style={{ fontSize: "2rem" }}
                  ></i>
        ...
        <div className="col-lg-6 d-flex align-items-center justify-content-center right-column p-4">
          ...
          >
            ...
            <form onSubmit={handleSubmit}>
              ...
              {errors.username && (
                <div className="text-danger mb-3 animate-error">
                  {errors.username}
                </div>
              )}
            ...
            <div className="mt-4 pt-3 border-top text-center">
              <p className="text-white small mb-0">
                &copy; 2025 Bayanat. All rights reserved.
              </p>
            </div>
          </div>
        </div>
