...
function Sidebar({ isOpen, toggleSidebar }) {
  ...
  useEffect(() => {
    ...
    if (Object.keys(newExpanded).length !== Object.keys(expandedMenus).length) {
      ...
      submenu: [
        {
          ...
          path: "/payment-creation/multiple-transaction",
        },
        ...
        {
          title: "Direct Debit with Mandate",
          path: "/payment-creation/direct-debit-with-mandate",
        },
        {
          title: "Create Free Text",
          path: "/payment-creation/create-free-text",
        },
        {
          title: "New Institution Transfer",
          path: "/payment-creation/new-institution-transfer",
        },
        {
          title: "Single Credit Transfer",
          path: "/payment-creation/single-credit-transfer",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      submenu: [
        { title: "Account Report", path: "/report/account-Report" },
        {
          ...
          path: "/report/statement-information",
        },
      ],
    },
    {
      ...
      submenu: [
        ...
        { title: "Profile", path: "/admin/profile" },
        {
          ...
          path: "/admin/authorization-management",
        },
        ...
        { title: "Add new bank", path: "/admin/add-new-bank" },
        {
          ...
          path: "/admin/add-new-transaction-type",
        },
        { title: "Batch management", path: "/admin/batch-management" },
        { title: "Batches", path: "/admin/batches" },
      ],
    },
    { title: "Configration", path: "/configration", icon: "fa-solid fa-cog" },
  ];
  ...
  const handleLinkClick = () => {
    if (window.innerWidth < 991.98) toggleSidebar();
  };
